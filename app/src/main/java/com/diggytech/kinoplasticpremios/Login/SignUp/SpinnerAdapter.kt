...
class SpinnerAdapter(val context: Context, var arrayList: List<LocationListData>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = arrayList.get(position).name
    ...
    open class ItemRowHolder(row: View?) {
