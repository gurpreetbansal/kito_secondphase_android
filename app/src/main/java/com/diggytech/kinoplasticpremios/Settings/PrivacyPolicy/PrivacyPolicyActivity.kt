package com.diggytech.kinoplasticpremios.Settings.PrivacyPolicy
...
class PrivacyPolicyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dialog = ProgressDialog(this@PrivacyPolicyActivity)
    ...
    private fun setToolBar() {
        ...
        mTitle!!.text = getString(R.string.privacy_policy)
    }
